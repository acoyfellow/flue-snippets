/** Gateproof plan for braintrust-otel. Required env: AGENT_URL. */
...
const plan = Plan.define({
  goals: [
    {
      id: 'worker-exports-otel-to-braintrust',
      title: 'A Flue prompt completes the Braintrust OTel exporter path',
      gate: Gate.define({
