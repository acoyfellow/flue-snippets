  ...
  goals: [
    {
      ...
      gate: Gate.define({
        ...
        act: [Act.exec(`AGENT_URL_BASE="${agentUrlBase}" bun run probe-first.ts`, { timeoutMs: 150_000 })],
    ...
    },
    {
      ...
      gate: Gate.define({
        act: [Act.exec(`AGENT_URL_BASE="${agentUrlBase}" bun run probe-mid.ts`, { timeoutMs: 200_000 })],
        assert: [Assert.noErrors()],
        timeoutMs: 230_000,
      }),
    },
